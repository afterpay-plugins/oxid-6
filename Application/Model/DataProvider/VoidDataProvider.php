 ...
 * @codeCoverageIgnore
 */
class VoidDataProvider extends \Arvato\AfterpayModule\Application\Model\DataProvider\DataProvider
{
    /**
    ...
    public function getDataObject(\OxidEsales\Eshop\Application\Model\Order $order, array $orderItems = null)
    {
        ...
        $dataObject = oxNew(\Arvato\AfterpayModule\Application\Model\Entity\VoidEntity::class);
