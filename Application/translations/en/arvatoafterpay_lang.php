...
$aLang = [
    ...
    'AFTERPAYOPTIN_PAYMENT_LABEL'                        => 'I hereby consent to the processing of my data for fraud prevention purposes in accordance with the <a href="/privacy">Privacy Policy</a>.',
    ...
    'AFTERPAY__PAYMENTSELECT_LEGAL_INSTALLMENT_ADDITION' => 'Here you will find the <a target="_new" href="%s">mandatory information</a> according to § 507 BGB (German Civil Code), the <a target="_new" href="%s">European Standard Information for Consumer Credit</a> and the <a target="_new" href="%s">Privacy Policy</a> of AfterPay. The <a target="_new" href="%s">General Terms and Conditions for AfterPay</a> apply.',
];
