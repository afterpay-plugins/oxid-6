...
$aLang = [
    ...
    "AFTERPAY_LEGAL_INVOICE_DEBITNOTE"                   => '<input id="checkAfterPayAgbTop" type="checkbox" name="ord_afterpay_agb" value="1">Ich habe die <a href="##AGBLINK##" target="_new" style="text-decoration:underline">Allgemeinen Geschäftsbedingungen</a> und <a href="##PRIVACYLINK##" target="_new" style="text-decoration:underline">Datenschutzbestimmungen</a> von AfterPay gelesen und akzeptiere diese.',
